...
export function HeroSection() {
    ...
    return (
        <section className="relative flex min-h-[80vh] flex-col items-center justify-center overflow-hidden px-4 md:px-8">
            ...
            {/* Decorative Grid */}
            <div className="absolute inset-0 bg-gradient-to-b from-white/5 to-transparent bg-center [mask-image:linear-gradient(180deg,white,rgba(255,255,255,0))] -z-20 opacity-20"></div>
        </section>
    )
}
